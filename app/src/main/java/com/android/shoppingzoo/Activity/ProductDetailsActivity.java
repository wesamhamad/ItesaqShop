        ...
        addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isInCart){
                    ...
                    Toast.makeText(ProductDetailsActivity.this,"تمت إضافة المنتج للسلة",Toast.LENGTH_LONG).show();
                    finish();
                }
                else{
                    Toast.makeText(ProductDetailsActivity.this,"المنتج مضاف مسبقَا",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
