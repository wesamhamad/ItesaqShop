...
public class CheckOutActivity extends AppCompatActivity {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(order.getTotalPrice()>0){
                            ...
                            Toast.makeText(CheckOutActivity.this, "لا يوجد منتجات في السلة", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void settingDataOnServer() throws ParseException {
        pd.show(this,"الرجاء الإنتظار...","سيتم تقديم الطلب حالًا ..");
        ...
        root.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(key).setValue(order).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(CheckOutActivity.this,"تم تقديم الطلب",Toast.LENGTH_LONG).show();
            }
        });
