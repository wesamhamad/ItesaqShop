        ...
        SignUPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userName)) {
                    name.setError("أدخل الاسم كاملًا");
                } else if (TextUtils.isEmpty(userEmail)) {
                    email.setError("أدخل البريد الإلكتروني");
                }
                else if (!userEmail.matches(emailPattern)) {
                    Toast.makeText(getApplicationContext(), "البريد الإلكتروني المدخل غير صحيح، أدخل لبريد الإلكتروني صحيح", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(userPass)) {
                    pass.setError("أدخل كلمة المرور");
                }
                else if (TextUtils.isEmpty(userAddress)) {
                    address.setError("أدخل موقعك");
                }
                else {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            myRootRef.child("Users").child(currentUserId).setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    //show message
                                    Toast.makeText(SignupUserActivity.this, "تم التسجيل بنجاح", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(SignupUserActivity.this, "تعذر إنشاء الحساب", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
